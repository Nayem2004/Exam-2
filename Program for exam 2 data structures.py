...
def add_student(student_list, student_id, name, score):
    # Creates a new Student object and add it to the student list
...
def sort_students(student_list):
    # Sorts the student list by score in descending order using bubble sort
...
def main():
    ...
    students = [Student(1, "Nayem", 88),Student(2, "Bill", 72),Student(3, "Jose", 95)]
    ...
    add_student(students, 4, "Alejandro", 85)
